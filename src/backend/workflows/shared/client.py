...
class AppiumHTTPClient:
    ...
    def finish_workflow_step(
        ...
        return self._request(
            ...
            f"/api/v1/workflow-runs/{run_id}/steps/{step_id}/finish",
        ...
        *,
        ...
        if not isinstance(body.get(result_key), dict):
            ...
            raise WorkflowHTTPError(
                ...
                f"The backend HTTP response is missing '{result_key}'.",
        ...
        *,
        ...
        try:
            ...
            raise WorkflowHTTPError(
                ...
                "The backend HTTP service could not be reached.",
        ...
        if not response.ok:
            ...
            raise WorkflowHTTPError(
                ...
                "The backend HTTP service rejected a workflow request.",
        ...
        if not isinstance(body, dict):
            ...
            raise WorkflowHTTPError(
                ...
                "The backend HTTP response must be a JSON object.",
